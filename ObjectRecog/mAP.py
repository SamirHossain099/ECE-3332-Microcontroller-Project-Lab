...
def mean_average_precision(
    ...
    """
        This implementation is for a single IoU
    """
    ...
    for c in range(num_classes):
        ...
        # img 0 has 3 bboxes
        # img 1 has 5 bboxes
        # amount_bboxes = {0:3,1:5} # a dictionary
        ...
        # used to keep track of target bb that have been tested thus far
